...
def loadIsDamaged():
  image_size = 150
  #Load the VGG model
  vgg_conv = VGG16(weights = "C:/Users/Shanmukha Yenneti/Desktop/Insure++/vggwt.h5",include_top=False, input_shape=(image_size, image_size, 3))
...
def loadDmgLoc():
  ...
  model.load_weights('dmgloc_weights.h5')
  return model
...
def loadDmgSev():
  ...
  model.load_weights('dmgsev_weights.h5')
  return model
...
def loadImg(path):
  K.clear_session()
  path = "C:/Users/Shanmukha Yenneti/Desktop/version 0/static/"+path
  model0 = loadIsCar()
